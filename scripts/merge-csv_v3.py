...
#squid = args[5]
#pizzly = args[5]
fusioncatcher_fusion_genes = args[5]
fusioncatcher_summary = args[6]
starfusion = args[7]
#stringtie = args[8]
vardict = args[8]
haplotypecaller = args[9]

csvfilenames=[ coverage, arriba, fusioncatcher_fusion_genes, fusioncatcher_summary, starfusion, vardict, haplotypecaller]
